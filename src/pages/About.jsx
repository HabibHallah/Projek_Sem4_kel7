    ...
    <div className="min-h-screen font-sans text-gray-800 p-8">
      ...
      <section className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          {[
            { name: "Ayu", role: "Founder & Formulator", image: "https://avatar.iran.liara.run/public/39" },
            { name: "Bima", role: "Desainer Kemasan", image: "https://avatar.iran.liara.run/public/50" },
            { name: "Citra", role: "Head of Marketing", image: "https://avatar.iran.liara.run/public/74" },
          ].map((m) => (
            <div
              key={m.name}
      ...
      {/* Misi & Nilai */}
      <section className="max-w-4xl mx-auto bg-white rounded-2xl shadow-md p-8 mt-16">
